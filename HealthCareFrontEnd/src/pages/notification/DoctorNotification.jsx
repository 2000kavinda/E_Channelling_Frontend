...
function DoctorNotification() {
  ...
  const patientCodePrefix = "DOC"; // The patient code prefix to filter notifications by

  useEffect(() => {
    // Fetch all notifications from the backend using notification service
    viewNotification()
      .then(response => {
        // Filter notifications by patientCode starting with 'DOC' or 'doc'
  ...
  // Updated function to truncate the message to 7 words
  const truncateMessage = (msg) => {
    if (!msg) {
      return "No message available"; // Default message when msg is null or undefined
    }
    ...
    <div className='flex flex-col w-screen h-full'>
      ...
      <div style={{ padding: '40px 20px' }}>
        ...
        <div style={{
          ...
          <h3 style={{ margin: 0, marginRight: '10px', fontSize: '20px' }}>Doctor Notification</h3>
