...
function EditDoctor() {
    ...
    const REST_API_BASE_URL = `http://localhost:8088/api/v1/doctor/update`;
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(REST_API_BASE_URL, updatedFormData,{params:{drRegNo} });
