...
function EditAdminSchedule() {
    ...
    const REST_API_BASE_URL = `http://localhost:8088/api/v1/schedule/update`;
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(REST_API_BASE_URL, updatedFormData, { params: { id } });
...
export default EditAdminSchedule